...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [856164.120172, 1244332.383155, 861405.647394, 1247168.749358], maxZoom: 28, minZoom: 13
    })
});
...
map.getView().fit([856164.120172, 1244332.383155, 861405.647394, 1247168.749358], map.getSize());
